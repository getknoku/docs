...
| `data-suggested-questions` | `suggestedQuestions` | Comma-separated text, optional `|icon-name` | Empty |
...
Questions containing commas or `|` should use the npm object form:
